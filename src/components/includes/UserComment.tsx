...
import { deleteComment, updateCurrentComment } from '../../firebasefunctions/sessionQuestion';
...
const UserComment = ({content, poster, timePosted, isTA, commenterId, commentId, questionId, deleteCommentsHelper, currentUser}: Props) => {
        ...
        <div className={"userComment " + (isTA ? "taComment": "")}>
            <div className="commentInnerWrapper">
                ...
                {isCommentEditable ? 
                    ...
                    <div className={(currentUser && currentUser.userId === commenterId) ? "commentBody" : "commentBody notUserComment"}>
                        {commentContent}
                    </div>
                }
                {currentUser && currentUser.userId === commenterId &&
                    <div className="commentButtons">
                        { isCommentEditable ?
                            <button className="commentButton commentPost" onClick={handleEditCommentPost}>Post</button>
                        :
                        <div className="notEditableButtonsWrapper">
                            ...
                            <div className="showDeleteMenu" >
                                ...
                                {deleteShow && 
                                    <button className="commentButton commentDelete" onClick={() => deleteCommentsHelper(commentId, questionId)}>Delete</button>
                                }
                            </div>
                        </div>
                        }
