...
function CourseSelection({ user, isEdit, allCourses }: Props): React.ReactElement {
    ...
    const selectedCoursesString =
        selectedCourses.length + numCoursesWithRoles === 0
            ? "No Classes Chosen"
            ...
            <div className="CourseSelection">
                ...
                <div className="selectionContent">
                    {currentCourses.length > 0 || isEdit ? (
                        <>
                            <div className="description">
                                <div className="title">{isEdit ? "Edit Your Classes" : "My Classes"}</div>
                    ...
                    {!isEdit && formerCourses.length > 0 ? (
                        <>
                            <div className="description">
                                <div className="subtitle">Former Classes</div>
                            </div>
