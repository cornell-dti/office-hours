...
export const ALL_SEMESTERS = ['SP20', 'FA20', 'SP21', 'FA21', 'SP22', 'FA22',
    'SP23', 'FA23', 'SP24', 'FA24', 'SP25', 'FA25', 'SP26']

export const MOBILE_BREAKPOINT = 920; // same as index.scss

export const START_DATE = '2026-01-20'
export const END_DATE = '2026-05-16'
...
export const WRAPPED_START_DATE = "2026-11-23T00:00:00";
export const WRAPPED_LAUNCH_DATE = "2026-12-03T00:00:00";
